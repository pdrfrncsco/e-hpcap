...
class _$UserModelImpl implements _UserModel {
  ...
  @override
  String toString() {
    return 'UserModel(id: $id, username: $username, email: $email, firstName: $firstName, lastName: $lastName, role: $role, telefone: $telefone, biografia: $biografia)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, username, email, firstName,
      lastName, role, telefone, biografia);
...
abstract class _UserModel implements UserModel {
  const factory _UserModel(
      ...
      final String? telefone,
      final String? biografia}) = _$UserModelImpl;
